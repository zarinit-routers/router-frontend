        ...
        <form @submit.prevent="onSubmit">
            <div class="form__fields">
                <div class="form__field flex flex-col text-left">
                    <Input v-model="email" label="Email" classLabel="text-xs text-[#54505B] pb-2 pt-3" classInput="p-4 rounded-lg w-full bg-[#37343D]" type="email" placeholder="" />
                </div>
                <div class="form__field flex flex-col text-left">
                    <Input v-model="password" label="Пароль" classLabel="text-xs text-[#54505B] pb-2 pt-3" classInput="p-4 rounded-lg w-full bg-[#37343D]" type="password" placeholder="" />
                </div>
            </div>
            <div class="form__controls pt-8">
                <button type="submit" class="p-3 rounded-[3vw] w-full bg-gradient-to-r from-[#452587] to-[#470ABF] text-white">Войти</button>
            </div>
        </form>
    </div>
</template>
