...
<template>
    <div class="flex flex-col gap-4">
          <div class="flex flex-row items-center gap-4">
            ...
            <button class="p-3 bg-[#37343D] border-1 border-solid border-[#27242C] text-nowrap text-xs">Информация о
              сети</button>
          </div>
          <div class="flex flex-row items-center gap-4">
            <img :src="wifi" alt="">
            ...
            <button class="p-3 bg-[#37343D] border-1 border-solid border-[#27242C] text-xs text-nowrap">Информация о
              сети</button>
          </div>
        </div>
</template>