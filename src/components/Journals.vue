                ...
                <div class="m-4 mb-[206px] ">
                  ...
                  <TabGroup @change="handleTabChange">
                    <TabList class="flex justify-center mb-4 gap-2">
                      <Tab v-for="type in journalTypes" :key="type" v-slot="{ selected }">
                        <button :class="[
                          'p-3 w-[200px] h-[100px] rounded-md',
                          selected ? 'bg-[#470ABF] text-white' : 'bg-[#37343D] hover:bg-[#4a4758] text-white'
                        ]">
                          {{ type }}
                        </button>
                      </Tab>
                    ...
                    <TabPanels class="flex justify-center">
                      <TabPanel v-for="type in journalTypes" :key="type">
                        <div
                          ...
                          <pre class="whitespace-pre-wrap break-words overflow-auto flex-1 p-2">{{ journalData }}</pre>
