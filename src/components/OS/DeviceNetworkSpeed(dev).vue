      ...
      <div class="flex gap-2 mb-6">
        ...
        <Listbox class="w-[270px]" v-model="selectedMetric">
          <div class="relative">
            ...
            <TransitionRoot>
              <ListboxOptions class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-[#37343D] py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
